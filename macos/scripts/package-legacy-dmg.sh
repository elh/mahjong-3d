...
DMG_STAGING="$BUILD_DIR/dmg-staging-legacy"
DMG="$BUILD_DIR/Mahjong3D-legacy-saver.dmg"
...
Mahjong 3D Legacy Screen Saver

Double-click Mahjong3D.saver to install it, then select Mahjong 3D in System Settings > Screen Saver.
This legacy artifact is intended for older macOS versions. Tahoe and newer should use Mahjong3D.app.
EOF

hdiutil create \
  -volname "Mahjong 3D Legacy" \
